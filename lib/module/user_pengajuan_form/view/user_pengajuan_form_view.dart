...
class UserPengajuanFormView extends StatefulWidget {
  final String jenisSurat;
  const UserPengajuanFormView({
    Key? key,
    required this.jenisSurat,
  }) : super(key: key);

  Widget build(context, UserPengajuanFormController controller) {
  ...
  @override
  State<UserPengajuanFormView> createState() => UserPengajuanFormController();
}
